const BestProperty = () => {
    return (
        <>
        <h1 className="my-8 text-5xl font-bold text-center ">The Best Seller
 ...
 <p className="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
        {/* <div className="justify-center items-center stats shadow mx-5 my-10 "> */}
        
        <div className="border border-red-500 justify-center items-center mb-10 shadow mx-5 my-10 overflow-x-auto">
