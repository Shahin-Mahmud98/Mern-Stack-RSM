...
```js
VITE_HOST = ` https://web-app-mern-server-db5s.onrender.com `
In Development => ` https://web-app-mern-server-db5s.onrender.com ` (default:5000)
...
key   : FRONTEND_DEV, value : ` https://web-app-mern-server-db5s.onrender.com `
